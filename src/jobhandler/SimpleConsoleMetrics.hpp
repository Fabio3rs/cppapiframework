...
class SimpleConsoleMetrics : public WorkerMetricsCallback {
  public:
    ...
    void onJobCompleted(const std::string &queue,
        ...
        switch (result) {
            case noerror: statusStr = "SUCESSO"; break;
            case errorremove: statusStr = "ERRO_PERMANENTE"; break;
            case errorretry: statusStr = "ERRO_RETRY"; break;
            case errexcept: statusStr = "EXCEÇÃO"; break;
        }
